...
@section('sidebar')
<nav class="space-y-1">
    <a href="{{ route('staff.dashboard') }}" class="flex items-center px-3 py-2 rounded text-gray-300 hover:bg-gray-700 hover:text-white">
        <i class="fas fa-home mr-3 text-sm"></i> Dashboard
    </a>
    <a href="{{ route('staff.appointments') }}" class="flex items-center px-3 py-2 rounded text-gray-300 hover:bg-gray-700 hover:text-white">
        <i class="fas fa-calendar mr-3 text-sm"></i> Appointments
    </a>
    <a href="{{ route('staff.assignments') }}" class="flex items-center px-3 py-2 rounded text-white bg-indigo-600">
        <i class="fas fa-user-plus mr-3 text-sm"></i> Assignments
    </a>
    <a href="{{ route('staff.records') }}" class="flex items-center px-3 py-2 rounded text-gray-300 hover:bg-gray-700 hover:text-white">
        <i class="fas fa-user-injured mr-3 text-sm"></i> Patient Records
    </a>
    <a href="{{ route('staff.billings') }}" class="flex items-center px-3 py-2 rounded text-gray-300 hover:bg-gray-700 hover:text-white">
        <i class="fas fa-credit-card mr-3 text-sm"></i> Billing
    </a>
</nav>
@endsection
...
<!-- Header -->
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Staff Assignments</h1>
    <p class="text-gray-600 mt-2">Assign doctors, nurses, and rooms to appointments</p>
</div>
