...
@section('content')
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-xl font-bold text-gray-800 tracking-tight">Appointments Management</h1>
                <p class="text-gray-600 text-sm mt-1">Manage all appointments</p>
            </div>
            <a href="{{ route('staff.appointments.create') }}" class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 shadow-md hover:shadow-lg transition-all duration-200 font-medium">
                ...
                @forelse($appointments as $appointment)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('staff.appointments.show', $appointment) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                            <a href="{{ route('staff.appointments.edit', $appointment) }}" class="text-green-600 hover:text-green-900">Edit</a>
                        </td>
                    </tr>
                @empty
                    <tr>
    ...
    <script>
        new AutoSearch({
            ...
            searchUrl: '{{ route("staff.appointments.search") }}',
                ...
                tbody.innerHTML = data.map(appointment => {
                    ...
                    return `
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="/staff/appointments/${appointment.id}" class="text-blue-600 hover:text-blue-800 transition-colors mr-3">View</a>
                                <a href="/staff/appointments/${appointment.id}/edit" class="text-green-600 hover:text-green-800 transition-colors">Edit</a>
                            </td>
                        </tr>
                    `;
                }).join('');
